...
class _TagNumberArray(Tag, MutableSequence[int]):
    ...
    @overload
    def __setitem__(self, index: slice, value: array[int]) -> None: ...
...
def read_nbt_file(file: Union[str, BinaryIO], *, with_name: bool = False) -> Union[Tag, Tuple[Tag, str]]: ...

def write_nbt_file(file: Union[str, BinaryIO], root: Tag, *, root_name: str = '', compress: bool = True) -> None: ...
