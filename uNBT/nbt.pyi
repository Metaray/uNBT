...
from typing import BinaryIO, Dict, Iterable, Iterator, List, Literal, Optional, Tuple, Type, TypeVar, Union, overload
...
class _TagNumberArray(Tag, MutableSequence[int]):
...
class TagList(Tag, MutableSequence[T]):
    tagid: int = ...
...
class TagCompound(Tag, MutableMapping[str, Tag]):
    tagid: int = ...
...
_PathOrFileLike = Union[str, PurePath, BinaryIO]

@overload
def read_nbt_file(file: _PathOrFileLike, *, with_name: Literal[False] = False) -> Tag: ...

@overload
def read_nbt_file(file: _PathOrFileLike, *, with_name: Literal[True]) -> Tuple[Tag, str]: ...

def write_nbt_file(file: _PathOrFileLike, root: Tag, *, root_name: str = '', compress: bool = True) -> None: ...
